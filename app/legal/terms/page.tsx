    ...
    <main className="min-h-screen bg-[#080808] text-white">
      ...
      <div className="max-w-2xl mx-auto px-5 py-8 space-y-6 text-sm text-neutral-300 leading-relaxed">
        ...
        <Section title="1. Acceptance of Terms">
          By creating an account or using Sway (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.
        </Section>

        <Section title="2. Eligibility">
          You must be at least 16 years old to use Sway. By using the Service, you confirm that you meet this age requirement and have the legal capacity to enter into this agreement.
        </Section>
        ...
        <Section title="4. User Conduct">
          When using Sway, you agree NOT to:
          <ul className="space-y-1 list-disc pl-5 mt-3 marker:text-neutral-600">
        ...
        <Section title="5. Meeting in Person — IMPORTANT">
          <p className="bg-amber-950/30 border border-amber-900/30 rounded-xl px-4 py-3 mb-3 text-amber-200/90">
            ⚠️ Sway connects you with strangers. <strong>Always exercise caution when meeting people in person.</strong>
          </p>
          By using Sway you acknowledge:
          <ul className="space-y-1 list-disc pl-5 mt-3 marker:text-neutral-600">
        ...
        <Section title="6. User Content">
          You retain ownership of the content you post. By posting on Sway, you grant us a worldwide, non-exclusive, royalty-free license to display, distribute, and use your content within the Service. You represent that:
          <ul className="space-y-1 list-disc pl-5 mt-3 marker:text-neutral-600">
        ...
        <Section title="7. Reviews and Trust System">
          You may leave reviews about users you have met through Sway. Reviews must be truthful, based on real interactions, and free from defamation, hate speech, or harassment. We reserve the right to remove reviews that violate these standards.
        </Section>
        ...
        <Section title="9. Service Availability">
          Sway is provided &quot;as is&quot; and &quot;as available&quot;. We do not guarantee uninterrupted service, error-free operation, or that any defects will be corrected. We may modify, suspend, or discontinue any part of the Service at any time without notice.
        </Section>

        <Section title="10. Disclaimer of Warranties">
          To the fullest extent permitted by law, Sway and its operators disclaim all warranties, express or implied, including but not limited to fitness for a particular purpose, merchantability, non-infringement, and accuracy of content. Use the Service at your own risk.
        </Section>

        <Section title="11. Limitation of Liability">
          To the maximum extent permitted by law, Sway and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, use, goodwill, or other intangible losses, resulting from:
          <ul className="space-y-1 list-disc pl-5 mt-3 marker:text-neutral-600">
        ...
        <Section title="12. Indemnification">
          You agree to indemnify and hold harmless Sway and its operators from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the Service, violation of these Terms, or violation of any third-party rights.
        </Section>
        ...
        <div className="pt-6 border-t border-white/5 text-xs text-neutral-600">
          By using Sway, you acknowledge that you have read, understood, and agreed to these Terms of Service.
        </div>
      </div>
    </main>
  );
